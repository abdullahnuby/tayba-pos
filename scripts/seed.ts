...
async function main() {
  ...
  // Default dev credentials — CHANGE THESE BEFORE PRODUCTION USE
  ...
  console.log(`✓ Created admin: ${ADMIN_USERNAME} (password from env or default "Admin@12345")`)
  console.log('✓ Brand: طيبة')

  // ---- Additional staff users (with strong passwords) ----
  ...
  console.log('✓ Created manager: manager / Manager@12345')
  console.log('✓ Created cashier: cashier / Cashier@123')
  ...
  console.log(`  admin / Admin@12345 (admin)`)
  console.log(`  manager / Manager@12345 (manager)`)
